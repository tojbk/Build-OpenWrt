...
function Diy_Part1() {
	...
	mv -f ${GITHUB_WORKSPACE}/build/common/luci-app-autoupdate $HOME_PATH/package/luci-app-autoupdate
...
Release_download2="${Release_download2}"
EOF
	bash <(curl -fsSL https://raw.githubusercontent.com/tojbk/Build-OpenWrt/main/build/common/autoupdate/replacebianliang.sh)
